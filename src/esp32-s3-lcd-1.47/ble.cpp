...
// ============================================================================
// NimBLE HID setup for ESP32-S3
// BLE HID (secondary transport — USB HID is primary when host detected)
// ============================================================================
...
void startAdvertising() {
  ...
  // Add NUS UUID so Web Bluetooth (Chrome) can discover the UART service
