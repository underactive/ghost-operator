...
// These mirror nrf52/state.cpp — all common/state.h externs must be defined here
// ============================================================================
...
// Encoder position (logical — no physical encoder on C6, but common code references these)
...
// Battery (C6 has no battery — static values)
...
// Button state (no physical buttons on C6, but common code references these)
